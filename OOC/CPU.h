...
#define DECLARE_CPU_METHODS(TYPE_POINTER) \
	...
	unsigned (*nInstructionTLBEntries) (TYPE_POINTER); \
	unsigned (*nDataTLBEntries) (TYPE_POINTER); \
	unsigned (*nUnifiedTLBEntries) (TYPE_POINTER); \
	void (*flushDataCacheAt) (TYPE_POINTER, void* address, size_t size); \
	void (*memoryFence) (TYPE_POINTER); 
...
#define DECLARE_CPU_INSTANCE_VARS(TYPE_POINTER) \
	...
	unsigned short nCores; \
	unsigned short cacheLineSize; /* bytes */ \
	unsigned short nInstructionTLBEntries; /* 4k pages assumed */ \
	unsigned short nDataTLBEntries; /* 4k pages assumed */ \
	unsigned short nUnifiedTLBEntries; /* 4k pages assumed */
...
extern unsigned CPU_levelNCacheSize (CPU *self, unsigned core, unsigned level, bool is_data);
