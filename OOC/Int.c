...
static void Int_print (Int* restrict self, FILE *outputFile) 
{ 
	if (!self) {
		return;
	}
...
static void Int_describe (Int* restrict self, FILE *outputFile) 
{ 
	if (!self) {
		return;
	}
...
static bool Int_equals (Int* restrict self, void *other_) 
{ 
	if (!self || !other_) {
		return false;
	}
	...
	verifyCorrectClass(other,Int);

	return self->integer == other->integer;
}

static unsigned Int_hash (Int* restrict self)
{
	if (!self) {
		return 0;
	}
...
static int Int_compare (Int* restrict self, Any *other_)
{
	if (!self || !other_) {
		return 0;
	}
	verifyCorrectClass(self,Int);
	verifyCorrectClass(other_,Int);
...
static const char* Int_asCString (Int* restrict self)
{
	if (!self) {
		return NULL;
	}
...
static int Int_asInt (Int* restrict self)
{ 
	if (!self) {
		return 0;
	}
...
static long Int_asLong (Int* restrict self)
{ 
	if (!self) {
		return 0L;
	}
...
static long long Int_asLongLong (Int* restrict self)
{ 
	if (!self) {
		return 0;
	}
...
static double Int_asDouble (Int* restrict self)
{ 
	if (!self) {
		return 0;
	}
...
static unsigned long Int_asUnsignedLong (Int* restrict self)
{
	if (!self) {
		return 0;
	}
...
static bool Int_asBool (Int* restrict self)
{ 
	if (!self) {
		return 0;
	}
...
IntClass* IntClass_init (IntClass *class)
{
	...
	SET_METHOD_POINTER(Int,asUnsignedLong);
	
        VALIDATE_CLASS_STRUCT(class);
	return class;
}

Int* Int_init (Int* restrict self)
{
