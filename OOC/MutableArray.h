...
#define DECLARE_MUTABLE_ARRAY_METHODS(TYPE_POINTER) \
	...
	void (*quicksort) (TYPE_POINTER, bool ascending); \
	void (*randomize) (TYPE_POINTER); \
	void (*setAt) (TYPE_POINTER, Any*, unsigned index); 
...
extern MutableArray* MutableArray_withObject (Any *object, unsigned count);
extern MutableArray* MutableArray_withArray (Any *arrayToCopy);
extern MutableArray* MutableArray_with (Any *first, ...);
