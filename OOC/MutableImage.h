/*============================================================================
  ...
  Copyright (C) 2009-2019, 2024 by Zack T Smith.
...
#define DECLARE_MUTABLE_IMAGE_METHODS(TYPE_POINTER) \
	...
	int (*drawChars) (TYPE_POINTER, const Char*, unsigned length, int x, int y, Font*, RGB); \
	...
	void (*flipVertially) (TYPE_POINTER); \
	void (*exchangeRedAndBlue) (TYPE_POINTER); 
