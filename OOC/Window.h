...
#define DECLARE_WINDOW_INSTANCE_VARS(TYPE_POINTER) \
	...
	Any *keyboardFocusView; /* not retained */ \
	Any *pointerFocusView; /* not retained */ 
...
#define DECLARE_WINDOW_METHODS(TYPE_POINTER) \
	...
	void (*setKeyboardFocusView) (TYPE_POINTER, Any*); \
	Any *(*keyboardFocusView) (TYPE_POINTER); \
	void (*setFullScreen) (TYPE_POINTER, bool); 
