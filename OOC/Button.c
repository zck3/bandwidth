...
static void Button_destroy (Any* restrict self)
{
        DEBUG_DESTROY;
...
static long Button_message (Button* restrict self, long message, Any *sender, long first, long second)
{
	if (!self) {
		return 0;
	}
...
Button* Button_init (Button* restrict self)
{
...
ButtonClass* ButtonClass_init (ButtonClass* restrict class)
{
