...
static DateTime *DateTime_previousDay (DateTime* restrict self)
{
	if (!self) {
		return NULL;
	}
...
static DateTime *DateTime_nextDay (DateTime* restrict self)
{
	if (!self) {
		return NULL;
	}
...
static const char *DateTime_dateString (DateTime* restrict self, char separator)
{
	if (!self) {
		return NULL;
	}
...
static const char *DateTime_timeString (DateTime* restrict self, char separator)
{
	if (!self) {
		return NULL;
	}
...
static bool DateTime_equals (DateTime* restrict self, void *other_) 
{ 
	if (!self || !other_) {
		return false;
	}
...
static void DateTime_print (DateTime* restrict self, FILE *outputFile) 
{ 
	if (!self) {
		return;
	}
...
static void DateTime_describe (DateTime* restrict self, FILE *outputFile) 
{ 
	if (!self) {
		return;
	}
...
DateTime* DateTime_init (DateTime* restrict self)
{
...
DateTimeClass* DateTimeClass_init (DateTimeClass* restrict class)
{
