...
#define DECLARE_VIEW_INSTANCE_VARS(FOO) \
	...
	MutableImage *drawable; \
        int borderWidth; \
        int cornerRadius; \
        RGB borderColor; \
        ViewBorderType borderType; \
	Any *controller; /* not retained */ \
	MutableArray *subviews; /* contains View objects */ 
...
#define DECLARE_VIEW_METHODS(TYPE_POINTER) \
	...
	bool (*needsRedraw) (TYPE_POINTER); \
	MutableImage *(*drawable) (TYPE_POINTER); \
	...
	void (*addSubview) (TYPE_POINTER, Any*); \
	bool (*hasSubviews) (TYPE_POINTER);
