...
#define RGB_PASTEL_GREEN (0xb0f0a0) 
#define RGB_PASTEL_BLUE (0xb0f4ff) 
#define RGB_PASTEL_RED (0xff6961) 
#define RGB_PASTEL_ORANGE (0xffb347) 
#define RGB_PASTEL_YELLOW (0xfff4a0) 
