...
#define DECLARE_DICTIONARY_METHODS(TYPE_POINTER) \
	Object *(*get) (TYPE_POINTER, String* /* key */); \
...
extern Dictionary* Dictionary_newWith (String*, Any*); // TODO Need variadic variant.
extern Dictionary* Dictionary_newWithCStrings (const char*, const char*);
